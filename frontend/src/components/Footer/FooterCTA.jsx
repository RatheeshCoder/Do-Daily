                ...
                <div className="flex flex-wrap items-center -mx-4">
                    <div className="w-full px-4 lg:w-1/2">
                        <div className="text-center lg:text-left ">
                            <div className="mb-10 lg:mb-0 ">
                                ...
                                <p className="w-full text-base font-medium leading-relaxed text-white sm:text-lg sm:leading-relaxed">
                    ...
                    <div className="w-full px-4 lg:w-1/2">
                        <div className="text-center lg:text-right">
                            <a className="inline-flex items-center justify-center py-4 mx-auto font-semibold bg-white rounded-lg px-9 hover:bg-opacity-90" href="#">
